...
remaining:
  - "prepared 2026-09-23, not released: PUBLICATION.md holds the release notes, the corrected description tail (the Steam page has SOURCE CODE before IF I GO QUIET and no licence line), the dependency and content-box answers, and three thanks drafts under 1000 characters. Blocked on the tested gate, on presentation screenshots that do not exist yet, and on a yes for the tag and GitHub release."
