...
remaining:
  ...
  - "scenario 10 corrected Pickle run passed 1/1: at 10-14% Contentment the cow held 3.3% milk fullness over one game hour, then reached 9.1% after restoration. Three reviewed captures and the complete report/log are preserved. The original @film stopped at its 60-second cap before the final state; a mid-scenario tick-film rerun is required for manual completion."
